...
/**<h1>Client Code</h1>
 * Class and main method that runs the DVDCollectionMod class
 */
public class IainMcLarenMoviesMod {
    public static void main(String[] args){
        IainMcLarenDVDCollectionMod movies = new IainMcLarenDVDCollectionMod();
